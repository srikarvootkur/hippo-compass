...
The health coach workflow attaches a curated evidence pack, calls the specialist service, and returns wellness coaching with citations, safety level, recommendation, and memory candidates.
